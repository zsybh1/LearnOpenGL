...
class DefaultApp2 : public Application {
public:
    DefaultApp2(int w, int h, const std::string& mTitle = "window", bool fullScreen = false) : Application(w, h, mTitle, fullScreen) {}
    virtual ~DefaultApp2() = default;
private:
    ...
    virtual void InitData() override {
        ...
        //meshes.push_back(New<Mesh>(R"(D:\Resources\nanosuit\nanosuit.obj)"));
        //meshes.push_back(New<Mesh>(R"(D:\Resources\living_room\living_room.obj)"));
