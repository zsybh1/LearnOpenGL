...
private:
    ...
    virtual void InitData() override {
        ...
        shaders.push_back(New<Shader>("Assets/Shader/Geometry/show_normal.vert", "Assets/Shader/Geometry/show_normal.geom", "Assets/Shader/Geometry/show_normal.frag"));
    ...
    virtual void RunLoop() override {
        ...
        Vec3f normal_color = Vec3f(0.9f, 0.8f, 0.f);
        float normal_len = 0.03f;
        ...
        while (!glfwWindowShouldClose(window)) {
            ...
            ImGui::DragFloat("normal_len", &normal_len, 0.001f, 0.f, 1.0f);
            ImGui::ColorEdit3("normal_color", normal_color.data());
            ImGui::End();
            ...
            shaders[3]->SetMat4f("model", model)
                ...
                .SetMat4f("projection", projection)
                .SetMat4f("normalTransform", normalTransform)
                .SetVec3f("color", normal_color)
                .SetFloat("len", normal_len);
            meshes[0]->Draw(*shaders[3]);
